      ...
      <div class="row" style="margin-bottom: ;"> 
      	<?php 
            ...
            <div class="col s8" style="text-align: left; font-weight:bold;">';
				...
				$urltemp2= split("iniciativas-nacionales", $_SERVER['HTTP_REFERER']);
				$urltemp3= split("search", $_SERVER['HTTP_REFERER']);
		         if(count($urltemp)>1){
		         ...
		         else if(count($urltemp3)>1){
		         	echo ('<a style="float:right;color:#f49715;font-weight:bold!important;font-size:20px;margin-right:50px;" href="javascript:history.back(1)"><img src="img/left-arrow.png" alt="" style="vertical-align: middle;" />&nbsp;&nbsp;Regresar</a>');
		         }
		         else{
		         	echo'<a style="float:right;color:#f49715;font-weight:bold!important;font-size:20px;margin-right:50px;" href="'.$_SERVER['HTTP_REFERER'].'&?temp='.$compips.'"><img src="img/left-arrow.png" alt="" style="vertical-align: middle;" />&nbsp;&nbsp;Regresar</a>';
		         }
