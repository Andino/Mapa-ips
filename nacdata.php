...
include ('cms/classes/DB.class.php'); 
    ...
    $comp = $_GET['q'];
            ...
            if(!empty($prueba)){
                ...
                <div class="row" style="margin-bottom:0;padding-top:;">
