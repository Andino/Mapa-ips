...
class DB {  
    ...
    public function selectSpecific($fields, $table, $where) {  
        $link = $this->connect();
    ...
    public function preSelectSpecific($fields, $table, $where) {  
        $link = $this->connect();

        $sql = "SELECT DISTINCT $fields FROM $table WHERE $where";  
        $result = mysqli_query($link, $sql); 
