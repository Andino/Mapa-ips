         ...
         <div class="col s3 fsection fsection-info"  >
	         		...
	         		<?php
						...
						foreach ($prueba as $key) {
							if($id=="ahuachapán"){
								echo '<img src="../frontend/img/depto-sideb/ahuachapan.svg" style="padding:0;">';
							}
							else if($id=="cabañas"){
								echo '<img src="../frontend/img/depto-sideb/cabanas.svg" style="padding:0;">';
							}
							else if($id=="cuscatlán"){
								echo '<img src="../frontend/img/depto-sideb/cuscatlan.svg" style="padding:0;">';
							}
							else if($id=="la unión"){
								echo '<img src="../frontend/img/depto-sideb/la union.svg" style="padding:0;">';
							}
							else if($id=="morazán"){
								echo '<img src="../frontend/img/depto-sideb/morazan.svg" style="padding:0;">';
							}
							else if($id=="usulután"){
								echo '<img src="../frontend/img/depto-sideb/usulutan.svg" style="padding:0;">';
							}
							else{
								echo '<img src="../frontend/img/depto-sideb/'.strtolower($key["nombre_dep"]).'.svg" style="padding:0;">';
							}
						}
		         	?>
         	...
         	<?php
				...
				foreach ($prueba as $key) {
					echo '	<div class="text-apartament">
    					<a href="index.php"><img src="img/left-arrow.png" alt="left" class="img-zoom"></a><span class="name-apartament">'.$key["nombre_dep"].'</span></div>';
				}
         	?>
